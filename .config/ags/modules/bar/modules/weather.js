...
const WeatherWidget = () => {
  ...
  const notificationIcon = MaterialIcon(
    "notifications",
    "large txt-norm txt-onLayer1"
  );
  ...
  const notificationContent = Box({
    hpack: "center",
    children: [notificationIcon, notificationTitleLabel, notificationBodyLabel],
  });
