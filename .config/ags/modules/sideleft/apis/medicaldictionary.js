...
export const medicalDictionaryTabIcon = TablerIcon("edbe", "norm");
          ...
          Box({
            ...
            children: [
              Label({
                ...
                hpack: "center",
                className:
                  "onSurfaceVariant  material-welcome-logo icon-material",
                label: "rib_cage",
              }),
            ],
          }),
          ...
          Box({
            ...
            children: [
              ...
              Button({
                ...
                onClicked: () =>
                  Utils.execAsync(`xdg-open https:merriamWebster.com`).catch(
                    print
                  ),
              }),
            ],
      ...
      MedicalDictionary.on("newEntry", (entry) => {
        ...
        if (container.get_children && container.get_children().length === 1) {
          ...
          if (
            ...
            firstChild.className.includes("welcome-message")
          ) {
