...
export const translaterIcon = TablerIcon("ef78", "norm");
...
export const sendMessage = (text) => {
  ...
  GoogleTranslater.send(text, {}).catch((e) => {
    console.log(e);
  });
};
        ...
        children: [
          ...
          Box({
            ...
            children: [
              ...
              message.original
                ? Box({
                    className: "separator-line margin-top-5 margin-bottom-5",
                  })
                : null,
              message.original
                ? Label({
...
const LanguageSwitcher = (type) => {
  const LanguageChoise = (language, name) => {
        ...
        self.hook(
          ...
          (self) => {
            self.toggleClassName(
              "invisible",
              GoogleTranslater.languages[type] !== language
            );
          },
          "languagesChanged"
        ),
    ...
    return Button({
      ...
      onClicked: () => {
        let t = GoogleTranslater.languages;
        t[type] = language;
  ...
  const indicatorButton = Button({
          ...
          setup: (self) =>
            self.hook(
              ...
              (self) => {
                ...
                self.label =
                  lang in GoogleTranslater.allLanguages
                    ? GoogleTranslater.allLanguages[lang]
                    : getString("Unknown");
              },
              "languagesChanged"
            ),
    ...
    onClicked: () => {
      ...
      indicatorChevron.label = languageList.revealChild
        ? "expand_less"
        : "expand_more";
    },
    setup: setupCursorHover,
        ...
        Box({
          ...
          setup: (self) =>
            self.hook(
              GoogleTranslater,
              (self) => {
                self.children = Object.entries(
                  GoogleTranslater.allLanguages
  ...
  return Box({
    ...
    child: Box({
      ...
      children: [indicatorButton, languageList],
    }),
  });
};
...
export const translaterCommands = Box({
  ...
  children: [Box({ hexpand: true }), CommandButton("/clear")],
});
    ...
    Scrollable({
      ...
      setup: (scrolledWindow) => {
        ...
        adjustment.connect("changed", () => {
          if (!TranslaterView.attribute.pinnedDown) {
            return;
          }
        ...
        adjustment.connect("value-changed", () => {
          TranslaterView.attribute.pinnedDown =
