export const gowallArr = [
  ...
  [
    ...
    { name: getString("Atom One Light"), value: "atom-one-light" },
    { name: getString("Sweet"), value: "sweet" },
    { name: getString("Night Owl"), value: "night-owl" },
    { name: getString("Ocianic"), value: "ocianic-next" },
    { name: getString("Gruvbox"), value: "gruvbox" },
    { name: getString("Purple Shades"), value: "shades-of-purple" },
  ],
];
export const schemeOptionsArr = [
  [
    ...
    { name: getString("Custom"), value: "scheme-custom" },
  ],
];
