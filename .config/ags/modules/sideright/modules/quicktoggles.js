  ...
  const button = Widget.Button({
    ...
    setup: (self) => {
      ...
      self.hook(Network, (button) => {
        ...
        button.tooltipText = `${
          Network.wifi?.ssid || getString("Unknown")
        } | ${getString("Right-click to configure")}`;
      });
    },
    ...props,
  });
...
export const ToggleIconCalendar = (props = {}) =>
  Widget.Button({
    className: "txt-small sidebar-iconbutton",
    onClicked: (self) => {
...
export const ModulePowerIcon = async (props = {}) =>
  Widget.Button({
    ...props,
    className: "txt-small sidebar-iconbutton",
