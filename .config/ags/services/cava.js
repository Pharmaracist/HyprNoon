...
class AudioVisualizerService extends Service {
  ...
  #proc = null;
  #config = {};
  #configFile = GLib.build_filenamev([
    App.configDir,
    "modules/.configuration/user_options.default.json",
  ]);
