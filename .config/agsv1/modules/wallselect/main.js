...
const CLICK_ACTION_SCRIPT = GLib.get_home_dir() + '/.config/ags/scripts/color_generation/switchwall.sh';
...
// Returns an object with the cached file name and the proper format string.
  ...
  Widget.Button({
    child: EventBox({
      setup: (self) => {
        ...
        GLib.idle_add(GLib.PRIORITY_DEFAULT_IDLE, loadImage);
        ...
        drawingArea.connect("draw", (widget, cr) => {
          ...
          if (pixbuf) {
            ...
            // Draw a placeholder while the preview loads.
