            ...
            Box({
                ...
                children: [
                    Label({
                        ...
                        setup: (self) => self.poll(opts.time.interval, label => {
                            label.label = GLib.DateTime.new_now_local().format(opts.time.format + " %p");
                        }),
                    }),
                ]
            }),
...
export default () => Box({
    ...
    children: [
        Time(),
        opts.desktopBackground.resources ? resources : null
    ],
})